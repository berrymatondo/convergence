    ...
    <div className="md:p-8 bg-gradient-to-br from-sky-900/10 to-sky-900 h-full">
      <div className="container py-48 max-md:py-4 flex max-md:flex-col gap-4 justify-between my-auto bg-gray-100 dark:bg-transparent">
        ...
        <div className="md:w-1/2 flex flex-col gap-8 max-md:gap-4 ">
          ...
          <p className="flex justify-center mx-auto w-full md:w-3/4 md:py-2 bg-gradient-to-r from-purple-600 to-orange-600 rounded-lg my-4 hover:bg-gradient-to-r hover:from-purple-500 hover:to-orange-500 hover:cursor-pointer">
            <Link
              href="/auth/login"
